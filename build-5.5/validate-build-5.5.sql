...
FROM model_versions WHERE version_name IN ('v13-directional-calibration','v14-baseline-challenger');
SELECT backtest_run_id,engine_version,status,eligible_row_count,distinct_test_dates,executed_fold_count
